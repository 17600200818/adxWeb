...
/*var tree_data = {
	'新浪' : {name: '新浪', type: 'folder'}	,
	'搜狐联盟' : {name: '搜狐联盟', type: 'folder'}	,
	'爱奇艺' : {name: '爱奇艺', type: 'folder'}

}
tree_data['新浪']['additionalParameters'] = {
	'children' : {
		'新浪首页广告位1' : {name: '新浪首页广告位1', type: 'item'},
		'新浪首页广告位2' : {name: '新浪首页广告位2', type: 'item'}
	}
}
tree_data['搜狐联盟']['additionalParameters'] = {
	'children' : {
		'搜狐娱乐' : {name: '搜狐娱乐', type: 'folder'},
		'搜狐联盟广告位1' : {name: '搜狐联盟广告位1', type: 'item'},
		'搜狐联盟广告位2' : {name: '搜狐联盟广告位2', type: 'item'}
	}
}
tree_data['搜狐联盟']['additionalParameters']['children']['搜狐娱乐']['additionalParameters'] = {
	'children' : {
		'搜狐娱乐广告位1' : {name: '搜狐娱乐广告位1', type: 'item'},
		'搜狐娱乐广告位2' : {name: '搜狐娱乐广告位2', type: 'item'}
	}
}

tree_data['爱奇艺']['additionalParameters'] = {
	'children' : {
		'爱奇艺贴片广告位1' : {name: '爱奇艺贴片广告位1', type: 'item'},
		'爱奇艺贴片广告位2' : {name: '爱奇艺贴片广告位1', type: 'item'}
	}
}
